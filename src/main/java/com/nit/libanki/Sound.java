...
public class Sound {
    ...
    private static ArrayList<String> okList = new ArrayList<String>(Arrays.asList("ok1.amr", "ok2.amr", "ok3.amr", "ok4.amr", "ok5.amr", "ok6.amr", "ok7.amr"
            , "ok8.amr", "ok9.amr", "ok10.amr", "ok11.amr", "ok12.amr", "ok13.amr", "ok14.amr", "ok15.amr", "ok16.amr", "ok17.amr"));
