...
import com.nit.anim.ViewAnimation;
...
import com.nit.libanki.Sched;
import com.nit.libanki.Stats;
    ...
    DeckTask.TaskListener mLoadStatisticsHandler = new DeckTask.TaskListener() {
        ...
        public void onPostExecute(DeckTask.TaskData result) {
            ...
            if (result.getBoolean()) {
                ...
                // } else {
                Intent intent = new Intent(getActivity(), com.nit.charts.ChartBuilder.class);
