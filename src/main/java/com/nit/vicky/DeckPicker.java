...
import com.nit.async.Connection.OldAnkiDeckFilter;
import com.nit.async.Connection.Payload;
import com.nit.async.DeckTask;
import com.nit.async.DeckTask.Listener;
import com.nit.async.DeckTask.TaskData;
import com.nit.charts.ChartBuilder;
    ...
    DeckTask.TaskListener mLoadStatisticsHandler = new DeckTask.TaskListener() {
        ...
        public void onPostExecute(DeckTask.TaskData result) {
            ...
            if (result.getBoolean()) {
                ...
                // } else {
                Intent intent = new Intent(DeckPicker.this, com.nit.charts.ChartBuilder.class);
