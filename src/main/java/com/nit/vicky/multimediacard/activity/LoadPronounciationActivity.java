...
import com.nit.vicky.multimediacard.beolingus.parsing.CibaResult;
import com.nit.vicky.multimediacard.language.LanguageListerBeolingus;
...
//        }
    ...
    private class BackgroundPost extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            // Should be just this
            return HttpFetcher.fetchThroughHttp(getAddress(), "UTF-8");
        }
